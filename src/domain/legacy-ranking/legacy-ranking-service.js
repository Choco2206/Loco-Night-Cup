...
function rankingPages(ranking, updatedAt = new Date().toISOString()) {
  const intro = ['🏛️ **LOCO LEGACY RANKING**', '', 'Die langfristige Gesamtwertung aller vom Bot erfassten Night Cups.', '**Wertung:** Sieg 3 Punkte · Unentschieden 1 Punkt · Niederlage 0 Punkte', '**Sortierung:** Punkte · Tordifferenz · Tore · Siege · Turniersiege', '', '```', 'PL TEAM                 CUPS   SP   S   U   N      TORE  DIFF   PKT'].join('\n');
