...
async function handleFc27CeremonyGraphicsTest(interaction) {
  ...
  try {
    ...
    await interaction.editReply({
      content: [
        `✅ FC-27-Check-in, alle ${result.days} Siegerehrungen, Special Awards, Power-Ranking-Champion, Live-Tabelle, Matches, acht K.O.-Grafiken und alle drei Road-to-Glory-Verläufe wurden in <#${result.channelId}> gepostet.`,
