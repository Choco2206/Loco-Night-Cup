...
async function handleFc27CeremonyGraphicsTest(interaction) {
  ...
  try {
    ...
    await interaction.editReply({
      content: [
        `✅ FC-27-Check-in, alle ${result.days} Siegerehrungen, Special Awards, Power-Ranking-Champion, Live-Tabelle, Matches, acht K.O.-Grafiken und der vollständige Road-to-Glory-Verlauf wurden in <#${result.channelId}> gepostet.`,
